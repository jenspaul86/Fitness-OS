...
Dieses Repo enthält `index.html` (Version 0.9.12), eine Single-File Web-App (reines HTML/CSS/JS, kein Framework). Die vollständige Projektübergabe (Datenstruktur, Regressionshistorie, Screens/UI-Ideen, Exportformate) liegt in `HANDOFF.md` im selben Repo – bei tieferen Fragen dort nachschlagen.
